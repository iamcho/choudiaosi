...
# 地址列表
addresses = [
'0xD5C65Ae3cF8B9E7eA7B542706F5f60AEEd380279',
'0xf60f639a2b668e86066E83fb0b7Db4589F180295',
'0x544364dB1b015E99a1CBB4331425Da7e22580340',
'0x17C67FEFC38E09442bbA6Ff8FedAea6b00380354',
'0x44709e52Bb294Ae7C20fd32756F2687E77880360',
'0x258A703dA09fa8166De20432EBE5D54368180384',
'0xF539eA5105509280BFe94BB13dA6e2d23f280410',
'0x5E287Fe85c0e57BB43a58a536E3a51196Fb80445',
'0xCE31D3F53914297Af319dB5711861157fF280446',
'0xe176f902b3aD39A091e0c5204C2FDa5475F80470',
'0xfC3ccAFb9c555BE9ab17aA46737C419eb2280471',
'0xBb7d9Fe49436DEd6dB33A279f54bDe77fBd80492',
'0x3980145da42397B986242174850cA3456Dd80525',
'0xbCb674E3F24f90A044d259d5a0b5825143F80546',
'0x9E86d18C2779cb35B7AB00CdF044e97fD9980551',
'0xcc79AF39bFD3cd15437899fF4272BcC15d480564',
'0x7263c54cCe3C2C704f807c3d9ac7374296B80576',
'0x54b74d93Eb754586D3F5D0a16ce7c1e36f780596',
'0xEa6B7D286423C77673cb5361D3A00c62fBe80748',
'0x1051Fc59Afe967839A6222a6734C0C8e4f480773',
'0xFC96EDF0E5aCAB2E925f36f3E461d99B71C80853',
'0x18e599fc6371D904BA8bf0793a518b6377280869',
'0x7Ac801a9791EF4Ab2826f8b7effB5e14C9F80874',
'0x59dDe158c6FeFAaba97D673cb47Cdc0838280880',
'0x6Ff4453FF9793A1315D072c9C93A05FB40780882',
'0xe5DAD3f10927Da46692221a0d0e38c4088480940',
'0x0735c108B070Ed7c6c2A80676bf260b5E8080941',
'0xDC0d7290AE342C5b94D289B67030c80327180943',
'0xDAF826038E21b87C43353B0E78792AD736f80979',
    # 添加更多地址...
]
# 当前挖第几个地址
    ...
    with tqdm(total=None, dynamic_ncols=True, desc=f"{GREEN}Mining{RESET}", unit=f" {GREEN}Blocks{RESET}") as pbar:
        ...
        while True:
            ...
            if submissions_count >= 3:
                current_address_index = (current_address_index + 1) % len(addresses)
                account = addresses[current_address_index]
                submissions_count = 0
                print(f"Switching to new address: {account}")
            try:
